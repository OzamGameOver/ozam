            ...
            var o = class {
                    ...
                    advance(t) {
                        ...
                        if (this.duration && this.easing) {
                            ...
                            let e = s(0, this.currentTime / this.duration, 1),
                                o = (i = e >= 1) ? 1 : this.easing(e);
                            this.value = this.from + (this.to - this.from) * o
                        } else if (this.lerp) {
                            var e, o, n, r;
                            this.value = (e = this.value, o = this.to, n = 60 * this.lerp, (1 - (r = 1 - Math.exp(-n * t))) * e + r * o), Math.round(this.value) === this.to && (this.value = this.to, i = !0)
                ...
                a = class {
                    ...
                    onWheel = t => {
                        let {
                            ...
                            deltaY: e,
                            deltaMode: s
                        } = t, o = 1 === s ? l : 2 === s ? this.window.width : 1, n = 1 === s ? l : 2 === s ? this.window.height : 1;
                        i *= o, e *= n, i *= this.options.wheelMultiplier, e *= this.options.wheelMultiplier, this.emitter.emit("scroll", {
                            deltaX: i,
                            deltaY: e,
                            event: t
                        })
                ...
                p = class {
                    ...
                    constructor({
                        ...
                        window.lenisVersion = "1.3.17", t && t !== document.documentElement || (t = window), "number" == typeof h && "function" != typeof p ? p = c : "function" == typeof p && "number" != typeof h && (h = 1), this.options = {
                            wrapper: t,
                            content: i,
                            eventsTarget: e,
                            smoothWheel: s,
                            ...
                            capture: !0
                        }), (this.options.anchors || this.options.stopInertiaOnNavigate) && this.options.wrapper.addEventListener("click", this.onClick, !1), this.options.wrapper.addEventListener("pointerdown", this.onPointerDown, !1), this.virtualScroll = new a(e, {
                            touchMultiplier: w,
                            wheelMultiplier: S
                    ...
                    onClick = t => {
                        let i = t.composedPath().filter(t => t instanceof HTMLAnchorElement && t.getAttribute("href"));
                        if (this.options.anchors) {
                            let t = i.find(t => t.getAttribute("href") ? .includes("#"));
                            if (t) {
                        ...
                        this.options.stopInertiaOnNavigate && i.find(t => t.host === window.location.host) && this.reset()
                    };
                    onPointerDown = t => {
                    ...
                    onVirtualScroll = t => {
                        ...
                        let l = "vertical" === this.options.gestureOrientation && 0 === e || "horizontal" === this.options.gestureOrientation && 0 === i;
                        if (r || l) return;
                    ...
                    raf = t => {
                        let i = t - (this.time || t);
                        this.time = t, this.animate.advance(.001 * i), this.options.autoRaf && (this._rafId = requestAnimationFrame(this.raf))
                    };
                    scrollTo(t, {
                        offset: i = 0,
                        immediate: e = !1,
                            ...
                            if ("number" == typeof t) {
                                if (t += i, t = Math.round(t), this.options.infinite) {
                                    if (n) {
                                        ...
                                        let i = t - this.animatedScroll;
                                        i > this.limit / 2 ? t -= this.limit : i < -this.limit / 2 && (t += this.limit)
                                    }
                                ...
                                n || (this.targetScroll = t), "number" == typeof l && "function" != typeof h ? h = c : "function" == typeof h && "number" != typeof l && (l = 1), this.animate.fromTo(this.animatedScroll, t, {
                                    duration: l,
                                    easing: h,
                                    lerp: r,
                                    onStart: () => {
                                    ...
                                    onUpdate: (t, i) => {
                                        this.isScrolling = "smooth", this.lastVelocity = this.velocity, this.velocity = t - this.animatedScroll, this.direction = Math.sign(this.velocity), this.animatedScroll = t, this.setScroll(this.scroll), n && (this.targetScroll = t), i || this.emit(), i && (this.reset(), this.emit(), p ? .(this), this.userData = {}, requestAnimationFrame(() => {
                                            this.dispatchScrollendEvent()
                    ...
                    checkNestedScroll(t, {
                        ...
                        let s, o, n, r, l, h, a, c, p, d, u, m, v, w, S = Date.now(),
                            f = t._lenis ? ? = {},
                        ...
                        if (S - (f.time ? ? 0) > 2e3) {
                            ...
                            let e = i.overflowX,
                                p = i.overflowY;
                            if (s = ["auto", "overlay", "scroll"].includes(e), o = ["auto", "overlay", "scroll"].includes(p), f.hasOverflowX = s, f.hasOverflowY = o, !s && !o || "vertical" === g && !o || "horizontal" === g && !s) return !1;
                        ...
                        if (!s && !o || !n && !r || "vertical" === g && (!o || !r) || "horizontal" === g && (!s || !n) || ("horizontal" === g ? p = "x" : "vertical" === g ? p = "y" : (0 !== i && s && n && (p = "x"), 0 !== e && o && r && (p = "y")), !p)) return !1;
                        if ("x" === p) d = t.scrollLeft, u = l - a, m = i, v = s, w = n;
                        else {
                            if ("y" !== p) return !1;
                            d = t.scrollTop, u = h - c, m = e, v = o, w = r
                        }
                        return (m > 0 ? d < u : d > 0) && v && w
                    }
                    get rootElement() {
