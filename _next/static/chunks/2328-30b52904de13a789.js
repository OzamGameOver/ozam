    ...
    [2328], {
        21453: (e, s, t) => {
            ...
            function u(e) {
                let {
                    ...
                    data: t,
                    update: u
                } = (0, i.wV)(), [x, h] = (0, l.useState)(""), [b, p] = (0, l.useState)(!1), [f, g] = (0, l.useState)(null), [j, v] = (0, l.useState)(""), [y, N] = (0, l.useState)(!1), [w, A] = (0, l.useState)(!1);
                (0, l.useEffect)(() => {
                    ...
                    let e = setTimeout(async () => {
                        ...
                        try {
                            let e = await fetch("/api/user/check-display-name", {
                                ...
                                s = await e.json();
                            s.success ? (g(s.available), s.available || v(s.error)) : v("فشل التحقق من الاسم")
                        } catch (e) {
                            v("حدث خطأ أثناء التحقق")
                        } finally {
                            p(!1)
                        }
                    }, 500);
                ...
                let S = async () => {
                    if (f && !y) {
                        ...
                        try {
                            ...
                            }), A(!1), null == s || s(t.displayName)) : v(t.error || "فشل حفظ الاسم")
                        } catch (e) {
                            v("حدث خطأ أثناء الحفظ")
                        } finally {
                            N(!1)
                        }
                    }
                };
                return w ? (0, a.jsx)(r.N, {
                                ...
                                children: [(0, a.jsxs)("div", {
                                    children: [(0, a.jsx)("label", {
                                        ...
                                        children: [(0, a.jsx)("input", {
                                            ...
                                            className: `input input-bordered w-full pr-10 ${x.length>=3?f?"input-success":!1===f?"input-error":"":""}`,
                                            maxLength: 20,
                                            disabled: y,
                                            autoFocus: !0,
                                            dir: "ltr"
        ...
        30610: (e, s, t) => {
            ...
            function c(e) {
                ...
                } = e, [n, c] = (0, l.useState)(t);
                return (0, a.jsx)(r.Provider, {
                    value: {
                        language: n,
                        direction: "ar" === n ? "rtl" : "ltr",
                        switchLanguage: e => {
                            ("en" === e || "ar" === e) && (c(e), document.cookie = `NEXT_LOCALE=${e}; path=/; max-age=31536000; SameSite=Lax`, window.location.reload())
                        },
                        t: e => {
                            let s = e.split("."),
                                t = i[n];
        ...
        38776: (e, s, t) => {
            ...
            var a = t(9339);
            let l = (0, a.createServerReference)("406f8e7024c50cac321bf1dece38194a3191666018", a.callServer, void 0, a.findSourceMapURL, "verifyTurnstileToken")
        },
        44550: (e, s, t) => {
            t.d(s, {
                A: () => h
            ...
            function h(e) {
                let {
                    ...
                    onClose: t,
                    callbackUrl: h
                } = e, b = h || window.location.pathname, [p, f] = (0, l.useState)(""), [g, j] = (0, l.useState)(!1), [v, y] = (0, l.useState)(!1), [N, w] = (0, l.useState)(""), [A, S] = (0, l.useState)(null), [C, M] = (0, l.useState)("pending"), k = async () => {
                    if (!A) return w("الرجاء إكمال التحقق الأمني."), !1;
                    let e = await (0, u.l)(A);
                    return !!e.success || (w(e.error || "فشل التحقق الأمني."), !1)
                }, P = async e => {
                    if (e.preventDefault(), w(""), await k()) {
                        j(!0);
                        try {
                            let e = await (0, i.Jv)("resend", {
                                email: p,
                                redirect: !1,
                                callbackUrl: b
                            });
                            (null == e ? void 0 : e.error) ? w("فشل إرسال رابط التحقق. يرجى المحاولة مرة أخرى."): y(!0)
                        } catch (e) {
                            w("حدث خطأ. يرجى المحاولة مرة أخرى.")
                        } finally {
                            j(!1)
                        }
                    }
                    ...
                    if (w(""), await k()) {
                        ...
                        try {
                            ...
                            w("حدث خطأ. يرجى المحاولة مرة أخرى."), j(!1)
                        }
                    }
                }, L = () => {
                    g || (f(""), y(!1), w(""), t())
                };
                return s ? (0, a.jsx)(r.N, {
                    children: (0, a.jsxs)("div", {
                        className: "fixed inset-0 z-50 flex items-center justify-center p-4",
                        children: [(0, a.jsx)(n.P.div, {
                            initial: {
                            ...
                            children: [(0, a.jsx)("button", {
                                ...
                                children: [(0, a.jsx)("h2", {
                                    className: "text-2xl md:text-3xl font-bold text-base-content mb-2",
                                    children: v ? "تحقق من بريدك!" : "تسجيل الدخول"
                                }), (0, a.jsx)("p", {
                                    className: "text-base-content/70",
                                    children: v ? "أرسلنا لك رابط تسجيل الدخول" : "سجل دخول لمشاركة الميديا…"
                                })]
                            }), v ? (0, a.jsxs)("div", {
                                ...
                                children: [(0, a.jsxs)("div", {
                                    ...
                                    children: [(0, a.jsx)(o.A, {
                                        className: "w-12 h-12 mx-auto text-success mb-2"
                                    }), (0, a.jsxs)("p", {
                                        className: "text-sm text-base-content/80",
                                        children: ["تحقق من بريدك الإلكتروني ", (0, a.jsx)("strong", {
                                            children: p
                                        }), " وانقر على الرابط لتسجيل الدخول"]
                                    })]
                                }), (0, a.jsx)("button", {
                                    onClick: () => y(!1),
                                    className: "btn btn-ghost btn-sm",
                                    children: "استخدام بريد إلكتروني آخر"
                                })]
                            }) : (0, a.jsxs)("div", {
                                className: "space-y-4",
                                children: [(0, a.jsx)("div", {
                                    className: "flex justify-center w-full min-h-[65px] py-2",
                                    children: (0, a.jsx)(m.Xs, {
                                        ...
                                        onError: () => {
                                            M("error"), w("فشل التحقق الأمني (Turnstile).")
                                        },
                                        onExpire: () => {
                                            M("expired"), S(null)
                                        }
                                    ...
                                    className: "space-y-2",
                                    children: ["false" !== x.env.NEXT_PUBLIC_GOOGLE_ENABLED && (0, a.jsxs)("button", {
                                        onClick: () => T("google"),
                                        disabled: g || !A,
                                    ...
                                    }), "false" !== x.env.NEXT_PUBLIC_DISCORD_ENABLED && (0, a.jsxs)("button", {
                                        onClick: () => T("discord"),
                                        disabled: g || !A,
                                        className: "btn btn-outline w-full",
        ...
        57953: (e, s, t) => {
            ...
            var a = t(95155),
                l = t(12115);
            let i = (0, t(37206).default)(() => Promise.all([t.e(6461), t.e(5385)]).then(t.bind(t, 35385)), {
                    loadableGenerated: {
                        webpack: () => [35385]
                    },
                    ssr: !1
            ...
            function n(e) {
                let {
                    children: s
                } = e, [t, n] = (0, l.useState)([]), c = (0, l.useCallback)(function(e) {
                    let s = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "info",
                        t = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : 3e3,
                ...
                return (0, a.jsxs)(r.Provider, {
                    ...
                    children: [s, t.length > 0 && (0, a.jsx)(i, {
                        toasts: t,
                        onRemove: o
                    })]
                })
        ...
        85003: (e, s, t) => {
            ...
            function u(e) {
                ...
                if (!t) return null;
                let u = t.displayName || t.name || (null == (s = t.email) ? void 0 : s.split("@")[0]),
                    x = (null == u ? void 0 : u.substring(0, 2).toUpperCase()) || "U";
                return (0, a.jsxs)("div", {
                    className: "dropdown dropdown-end",
                    children: [(0, a.jsx)(i.P.button, {
                        tabIndex: 0,
                        ...
                        children: [(0, a.jsx)("li", {
                            className: "menu-title px-4 py-2",
                            children: (0, a.jsxs)("div", {
                                className: "flex flex-col items-start",
                                children: [(0, a.jsx)("span", {
                                    className: "font-bold text-base-content",
                                    children: u
                                }), t.displayName && (0, a.jsxs)("span", {
                        ...
                        }), t.isAdmin && (0, a.jsxs)(a.Fragment, {
                            children: [(0, a.jsx)("li", {
                                children: (0, a.jsxs)(d(), {
                                    href: "/admin",
                                    className: "flex items-center gap-2 justify-between text-purple-600",
                                    children: [(0, a.jsx)("span", {
                                        children: o("nav.admin")
                                    }), (0, a.jsx)(r.A, {
                                        className: "w-4 h-4"
                                    })]
                                })
                            ...
                            children: (0, a.jsxs)("button", {
                                ...
                                className: "flex items-center gap-2 justify-between text-error",
                                children: [(0, a.jsx)("span", {
                                    children: o("nav.logout")
                                }), (0, a.jsx)(c.A, {
                                    className: "w-4 h-4"
                                })]
                            })
